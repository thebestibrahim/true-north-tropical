...
export const products: Product[] = [
  ...
  },
  {
    ...
    unit: 'bunch',
    price: 4.49,
    description: 'Also known as Shoko — rich, flavourful, deeply nutritious',
    image: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    unit: 'bunch',
    price: 6.49,
    description: 'Fluted pumpkin leaf — cornerstone of Nigerian cuisine',
    image: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=600&auto=format&fit=crop',
    featured: true,
  ...
  },
  {
    ...
    unit: 'kg',
    price: 14.99,
    description: 'Rare and deeply aromatic — hard to find this fresh',
    image: 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    unit: 'kg',
    price: 8.99,
    description: 'Punchy and fragrant — nothing like the store',
  ...
  // HERBS
  {
    ...
    unit: 'bunch',
    price: 3.99,
    description: 'Efirin — fragrant African basil for stews and jollof',
  ...
  // FRUITS
  {
    ...
    unit: 'each',
    price: 6.99,
    description: 'African horned melon — striking, tropical, conversation-starting',
  ...
  },
  {
    ...
    unit: 'each',
    price: 12.99,
    description: 'Old-school seeded variety — sweeter, more flavourful',
